...
<div class="container" style="font-family:幼圆;">
    <form class="form-signin" role="form" action="" target="_parent">
        ...
        <div class="form-group">
            <label for="">
                帐号</label>
            <input id="ln" type="text" class="form-control" placeholder="帐号"/>
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">
                密码</label>
            <input id="pw" type="password" class="form-control" placeholder="密码"/>
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">
                密码确认</label>
            <input id="_pw" type="password" class="form-control" placeholder="密码确认"/>
        </div>
        <!--
        <div class="form-group">
            <label for="exampleInputPassword1">
        ...
        <div class="form-group">
            <label for="exampleInputPassword1">
                学号</label>
            <input id="no" type="text" class="form-control" placeholder="学号"/>
        </div>
        <div class="form-group">
